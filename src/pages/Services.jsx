...
const SERVICES = [
  ...
  { id: "web", num: "03 / PRACTICE", title: "Website", titleSerif: "development.", lede: "Marketing sites and web applications that look like the company you're becoming.", body: "Most agency sites are templates with your logo dropped in. We design and build from scratch — a real visual identity, motion that means something, and engineering that holds up under load. Every site ships with the performance, accessibility, and SEO groundwork done properly, not bolted on after launch.", deliverables: [["01", "Design system + brand", "Type, colour, motion — a system, not a one-off page."], ["02", "React / Next.js build", "Component-driven, typed, and genuinely maintainable."], ["03", "CMS integration", "Your team edits content without calling us."], ["04", "Performance & SEO", "Core Web Vitals, structured data, and clean metadata from day one."], ["05", "Accessibility", "Keyboard paths, contrast, reduced-motion — handled, not skipped."], ["06", "Analytics & deployment", "CI/CD, preview builds, and dashboards that tell you what's working."]] },
  { id: "apps", num: "04 / PRACTICE", title: "Mobile app", titleSerif: "development.", lede: "iOS and Android apps built from one codebase, shipped to both stores.", body: "We build cross-platform apps that feel native on each side — not a website in a wrapper. Offline behaviour, push notifications, payments, and store submission are part of the build, not an afterthought. When your product needs an AI layer, it's designed into the app rather than stapled to it.", deliverables: [["01", "iOS + Android", "One React Native codebase, native feel on both platforms."], ["02", "Offline-first", "Local state and sync that survives a bad connection."], ["03", "Push & deep links", "Notifications and routing wired end to end."], ["04", "Payments & subscriptions", "In-app purchases, RevenueCat, Stripe."], ["05", "Store submission", "App Store and Play Store review handled, first submission onward."], ["06", "OTA updates & crash reporting", "Ship fixes without waiting on review queues."]] },
  { id: "copilots", num: "05 / PRACTICE", title: "Internal", titleSerif: "copilots.", lede: "Custom AI coworkers, trained on your data, wired into your tools.", body: "Generic chatbots don't move the needle. We build copilots for specific roles — each grounded in your private data, your past decisions, and your team's actual working patterns.", deliverables: [["01", "Private RAG pipelines", "Over your docs, tickets, code, transcripts."], ["02", "Custom UI per role", "Not another chat window — the right interface."], ["03", "Permissions & audit", "Row-level access, full audit trail, SOC-ready."], ["04", "Voice + chat", "Slack, email, voice — wherever the team lives."], ["05", "Continuous fine-tuning", "Quarterly evaluation against your own examples."], ["06", "Integrations", "Notion, Linear, Hubspot, QuickBooks, your CRM."]] },
  { id: "workflows", num: "06 / PRACTICE", title: "Custom", titleSerif: "workflows.", lede: "Bespoke automations stitched across the tools you already use.", body: "Most operational pain isn't in your tools — it's in the gaps between them. We build the AI-powered glue: document intelligence pipelines, invoice routing, voice-ops handlers, KPI digests, exception triage.", deliverables: [["01", "ETL & data pipelines", "Reliable ingest from APIs, files, voice, email."], ["02", "Document intelligence", "PDFs, forms, contracts — structured, validated, routed."], ["03", "Webhook orchestration", "Event-driven flows with retries and dead-letter handling."], ["04", "Voice ops", "Inbound and outbound calls with structured handoffs."], ["05", "Reporting & KPI digests", "Weekly executive briefings, written by an agent."], ["06", "Operational dashboards", "One screen the founder actually looks at."]] },
  { id: "strategy", num: "07 / PRACTICE", title: "AI", titleSerif: "strategy.", lede: "Embedded as a founding partner — your thinking partner on every AI decision.", body: "For founders who want a peer in the room. We embed with your leadership for two days a month — auditing your operations, sequencing your AI bets, vetting your hires, and writing the 12-month roadmap.", deliverables: [["01", "Operating audit", "Two weeks. Every workflow mapped. Highest-leverage bets ranked."], ["02", "12-month roadmap", "Sequenced, costed, with success criteria written upfront."], ["03", "Hiring & vendor plan", "Who to hire, who to fire, who to buy from."], ["04", "Quarterly reviews", "Board-ready materials. The story you actually want to tell."], ["05", "On-call thinking partner", "Slack access, weekly syncs, midnight texts when it matters."], ["06", "Founder workshops", "We run workshops with your team — they learn the patterns too."]] },
];
      ...
      <section className="page-hero" data-screen-label="01 Systems Hero">
        ...
        <div className="page-hero__inner" style={{ position: "relative", zIndex: 1 }}>
          <div>
            ...
            >
              Seven practices.<br /><span className="serif">One operating thesis.</span>
            </motion.h1>
          </div>
          <motion.p
          ...
          >
            Every engagement starts with one question: where in your company does work happen that doesn't have to? We answer it seven ways.
          </motion.p>
        </div>
      </section>
